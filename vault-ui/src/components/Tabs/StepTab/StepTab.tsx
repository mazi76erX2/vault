...
export function StepTab({ onTabItemChanged, items, activeIndex, noSubHeaders }: StepTabProps) {
        ...
        <Stack>
            <Box sx={{
                ...
                <Typography variant={'h2'} sx={{
                    ...
                    fontWeight: 'bold',
                    minWidth: '117px'
                }}>STEP {active + 1} OF {items.length}</Typography>
                <Box sx={{
                    display: 'flex',
                    alignItems: 'center',
                }}>
            ...
            {!noSubHeaders && (
                <Typography variant={'h2'} sx={{
                    mb: 4.4,
                    fontWeight: 'bold'
                }}>{activeItem.label.toUpperCase()}</Typography>
            )}
