    ...
    return (
        <Container>
            ...
            <DancingBotGridComponent botState={'greeting'}>
                {/* Welcome Header */}
                <HeaderContainer>
                    <WelcomeText>Welcome to <br /> HICO Vault Collector Chat.</WelcomeText>
                </HeaderContainer>

                {/* Action Cards */}
                <ActionContainer>
                    <ActionCard onClick={() => navigate('/applications/collector/CollectorResumePage')}>
                        <h3>Continue <br /> an existing session</h3>
                        <p>Click here to select one of your unfinished interviews.</p>
                    </ActionCard>

                    <ActionCard onClick={() => navigate('/applications/collector/CollectorStartPage')}>
                        <h3>Start <br /> a new session</h3>
                        <p>Click here to start a new interview.</p>
                    </ActionCard>

                    <ActionCard onClick={() => navigate('/applications/collector/CollectorDocumentsStatusPage')}>
