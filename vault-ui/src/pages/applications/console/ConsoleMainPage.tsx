...
const ConsoleMainPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const loadUserInfo = async () => {
            try {
                const response = await fetch(`${VAULT_API_URL}/api/console-main/user-info/${authContext.user?.user.id}`);
            ...
            <DancingBotGridComponent botState={'greeting'}>
                <ContentWrapper>
                    <HeaderContainer style={{ textAlign: 'center' }}>
                        <WelcomeText>Welcome to<br/>HICO Vault Validator!</WelcomeText>
                    </HeaderContainer>
                    ...
                    {isValidator === true && (
                        <CardContainer>
                            ...
                            <ActionContainer>
                                <ActionCard onClick={() => navigate('/applications/console/ValidatorStartPage')}>
                                    <h3>Validator Packages</h3>
                                    <p>Review Data packages from the Collector.</p>
                                </ActionCard>

                                <ActionCard
                                    onClick={() => navigate('/applications/console/ValidatorStartExpertReviewPage')}>
                                    <h3>Collector<br/>Packages in Expert review</h3>
                                    <p>List of Data packages sent for review by Experts.</p>
                                </ActionCard>

                                <ActionCard
                                    onClick={() => navigate('/applications/console/ValidatorStartCompletedPage')}>
                                    <h3>Validator<br/>completed Packages</h3>
                    ...
                    {isExpert === true && (
                        <CardContainer>
                            ...
                            <ActionContainer>
                                <ActionCard onClick={() => navigate('/applications/console/ExpertStartPage')}>
                                    <h3>Reviews Pending</h3>
                                    <p>List of Data packages you have been selected to review as an Expert on the
                                        matter.</p>
                                </ActionCard>

                                <ActionCard onClick={() => navigate('/applications/console/ExpertPreviousReviewsPage')}>
