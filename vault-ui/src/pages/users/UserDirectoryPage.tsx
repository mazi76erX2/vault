...
import { HCButton, HCTextField, HCLoader, success, error as showError } from 'generic-components';
...
const UserDirectoryPage: React.FC = () => {
    ...
    const [activeTab, setActiveTab] = useState<'server' | 'user' | 'group'>('server');
    ...
    const fetchDirectoryConfig = async () => {
        try {
            ...
            const response = await axios.get(`${VAULT_API_URL}/api/ldap/directory/config/${companyId}`);
    ...
    const handleTestConnection = async () => {
        try {
            setLoading(true);
            const response = await axios.post(`${VAULT_API_URL}/api/ldap/directory/test-connection`, formData);
    ...
    const handleSyncDirectory = async () => {
        ...
        try {
            setLoading(true);
            const response = await axios.post(`${VAULT_API_URL}/api/ldap/directory/sync/${companyId}`);
    ...
    return (
        <Container>
            ...
            <DancingBotGridComponent botState={'default'}>
                ...
                <TabContainer sx={{ border: '1px solid #e66334', borderRadius: '4px 4px 0 0', backgroundColor: '#d3d3d3' }}>
                    <Tab
                                ...
                                <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                                    ...
                                    <Box>
                                        ...
                                        <HCTextField
                                            ...
                                            onChange={(e) => setFormData({...formData, userDN: e.target.value})}
                                        />
                                    </Box>
                                    <Box>
                                        ...
                                        <HCTextField
                                            ...
                                            onChange={(e) => setFormData({...formData, groupDN: e.target.value})}
                                        />
                                    </Box>
                                        ...
                                        <FormControlLabel
                                            control={
                                                <Checkbox
                                                    ...
                                                    onChange={(e) => setFormData({...formData, sslConnection: e.target.checked})}
                                                />
                                            }
                                ...
                                <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                                    <Box>
                                        ...
                                        <HCTextField
                                            ...
                                            onChange={(e) => setFormData({...formData, userObject: e.target.value})}
                                        />
                                    </Box>
                                    <Box>
                                ...
                                <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                                    ...
                                    <Box>
                                        ...
                                        <HCTextField
                                            ...
                                            onChange={(e) => setFormData({...formData, userObjectRDN: e.target.value})}
                                        />
                                    </Box>
                                    <Box>
                                ...
                                <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                                    <Box>
                                        ...
                                        <HCTextField
                                            ...
                                            onChange={(e) => setFormData({...formData, groupObject: e.target.value})}
                                        />
                                    </Box>
                                    <Box>
                                        ...
                                        <FormControlLabel
                                            control={
                                                <Checkbox
                                                    ...
                                                    onChange={(e) => setFormData({...formData, fetchRecursively: e.target.checked})}
                                                />
                                            }
