...
import { HCTextField, HCButton, success, error as showError } from 'generic-components';
import { useAuthContext } from '../../../hooks/useAuthContext';
import axios from 'axios';
import { VAULT_API_URL } from '../../../config';
import { DirectoryFormData } from '../types';
import { FormSection, FormBox, TabContainer, Tab } from '../OrganisationDetailsPage';
import {
    Title,
    Subtitle,
    FieldLabel,
...
const UserDirectorySetup: React.FC<UserDirectorySetupProps> = ({ onBack }) => {
    ...
    const [directoryFormData, setDirectoryFormData] = useState<DirectoryFormData>({
        ...
        port: '636',
        username: 'hico-group\\hicoservice',
        password: '••••••••••••••••••',
        syncInterval: '60',
        searchTimeout: '60',
        baseDN: 'DC=hico-group, DC=local',
        userDN: 'OU=HICO-GROUP',
        groupDN: 'OU=HICO-GROUP',
        sslConnection: true,
    ...
    const handleSaveDirectoryConfig = async () => {
        ...
        try {
            ...
            await axios.post(`${VAULT_API_URL}/api/ldap/directory/config`, dataToSend);
    ...
    return (
        <>
            ...
            <HCTextField
                ...
                onChange={(e) => setDirectoryFormData({...directoryFormData, directoryType: e.target.value})}
                disabled
            />
                    ...
                    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, name: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, domain: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, host: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, port: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, username: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, password: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, syncInterval: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, searchTimeout: e.target.value})}
                            />
                        </Box>
                    </Box>
                    ...
                    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, baseDN: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, userDN: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, groupDN: e.target.value})}
                            />
                        </Box>
                            ...
                            <FormControlLabel
                                control={
                                    <Checkbox
                                        ...
                                        onChange={(e) => setDirectoryFormData({...directoryFormData, sslConnection: e.target.checked})}
                                    />
                                }
                    ...
                    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, userObject: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, userFilter: e.target.value})}
                            />
                        </Box>
                    </Box>
                    ...
                    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                        ...
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, userObjectRDN: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, firstName: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, lastName: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, displayName: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, principalName: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, email: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, uniqueId: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, userGroups: e.target.value})}
                            />
                        </Box>
                    </Box>
                </>
                    ...
                    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, groupObject: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, groupFilter: e.target.value})}
                            />
                        </Box>
                        <Box sx={{ display: 'flex', alignItems: 'center', gridColumn: '1 / span 2' }}>
                            <FormControlLabel
                                control={
                                    <Checkbox
                                        name='fetchRecursively'
                                        checked={directoryFormData.fetchRecursively}
                                        onChange={(e) => setDirectoryFormData({...directoryFormData, fetchRecursively: e.target.checked})}
                                    />
                                }
                    ...
                    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, groupUniqueId: e.target.value})}
                            />
                        </Box>
                        <Box>
                            <FieldLabel>Name</FieldLabel>
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, groupName: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, groupDescription: e.target.value})}
                            />
                        </Box>
                        <Box>
                            ...
                            <HCTextField
                                ...
                                onChange={(e) => setDirectoryFormData({...directoryFormData, groupMembers: e.target.value})}
                            />
                        </Box>
                    </Box>
                </>
