...
from app.services.file_processor import chunk_text, process_file
    ...
    try:
        ...
        try:
            ...
            if len(chunks) == 1:
                ...
                result = await store_bulk_in_kb(docs_to_store, db=db)
...
async def delete_document(
    ...
    try:
        result = await delete_from_kb(doc_id, db=db)
        return result
...
async def get_kb_stats(
    ...
    try:
        ...
        # Get counts
        total_docs = await get_document_count(db=db, company_id=company_id)
