...
from store_data_in_kb import store_confluence_in_qdrant


def main(args):
    confluence_url = "https://groupconfluence.atlassian.net/wiki"
    username = "aziz.raies@-group.com"
    ...
    store_confluence_in_qdrant(
        confluence_url, username, api_key, space_key, collection_name="confluence-kb"
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--folder_path",
        type=str,
        default=r"C:\Users\ars\OneDrive - highcoordination.de\KnowledgeBaseProjects\KB_docs",
